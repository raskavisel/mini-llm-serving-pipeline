...
On mobile (Pydroid), MLflow installation can be skipped due to Rust/build dependency limitations.
...
- When average latency exceeds threshold, drift is detected, and retraining is triggered automatically.

## Future Enhancements

- Integrate real LLMs (LLaMA, Alpaca, GPT-like models)
- Add real MLflow tracking & model registry
